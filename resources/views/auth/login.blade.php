...
<section class="p-3 p-md-4 p-xl-5">
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-6 bsb-tpl-bg-platinum" src="https://unpkg.com/bs-brain@2.0.4/components/logins/login-3/assets/img/login-3-bg.jpg">
          <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
            <h3 class="m-0">Welcome!</h3>
            <img class="img-fluid rounded mx-auto my-4" loading="lazy" width="245" height="80" alt="BootstrapBrain Logo">
